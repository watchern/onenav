	  ...
	  ?>
		...
		<div class="index-main">
			...
			?>
							...
							?>
							<div class="list siteList" data-url="./index.php?cid=<?php echo $category['id']; ?>" data-links="./index.php?cid=<?php echo $category['id']; ?>">
								<img src="./index.php?c=ico&text=更" class="icon" />
								<p class="title">
									查看更多>>
								</p>
